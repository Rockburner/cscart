...
$config['db_name'] = 'cscart_review';
$config['db_user'] = 'cscart_review';
$config['db_password'] = 'cscart_review';
...
$config['http_host'] = '192.168.1.102';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = '192.168.1.102';
$config['https_path'] = '';

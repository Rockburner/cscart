<?php /* Smarty version Smarty-3.1.21, created on 2017-08-15 17:12:44
         compiled from "/var/www/html/design/backend/templates/views/debugger/debugger.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13882757265993015c1b87b6-74768907%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9b10636091817bc7d1b4032d714b900185375eb6' => 
    array (
      0 => '/var/www/html/design/backend/templates/views/debugger/debugger.tpl',
      1 => 1502160056,
      2 => 'backend',
    ),
  ),
  'nocache_hash' => '13882757265993015c1b87b6-74768907',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5993015c1e7915_52888715',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5993015c1e7915_52888715')) {function content_5993015c1e7915_52888715($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/app/functions/smarty_plugins/function.script.php';
...
<div id="DebugToolbar">
    <img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['debugger_images_dir']->value, ENT_QUOTES, 'ISO-8859-1');?>
/bug.png" class="deb-bug" />
    <div class="deb-content">
    <div class="deb-panel">
        <a href="#" class="deb-logo"><img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['debugger_images_dir']->value, ENT_QUOTES, 'ISO-8859-1');?>
/logo.png"></a>
        <?php if (@constant('DEBUG_MODE')!==true) {?>
            ...
            <a href="<?php echo htmlspecialchars(fn_url("debugger.quit?redirect_url=".((string)$_smarty_tpl->tpl_vars['current_url']->value)), ENT_QUOTES, 'ISO-8859-1');?>
" id="DebugToolbarQuit" class="deb-x">&#10006;</a>
        <?php }?>
        <ul class="deb-menu">
            <li><a class="cm-ajax cm-ajax-cache" href="<?php echo htmlspecialchars(fn_url("debugger.server?debugger_hash=".((string)$_smarty_tpl->tpl_vars['debugger_hash']->value)), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id="DebugToolbarTabServerContent" data-tab-content-id="#DebugToolbarTabServer">Server<small><?php echo htmlspecialchars(@constant('PRODUCT_NAME'), ENT_QUOTES, 'ISO-8859-1');?>
: version <b><?php echo htmlspecialchars(@constant('PRODUCT_VERSION'), ENT_QUOTES, 'ISO-8859-1');?>
 <?php echo htmlspecialchars(@constant('PRODUCT_EDITION'), ENT_QUOTES, 'ISO-8859-1');?>
 <?php if (@constant('PRODUCT_STATUS')!='') {?> (<?php echo htmlspecialchars(@constant('PRODUCT_STATUS'), ENT_QUOTES, 'ISO-8859-1');?>
)<?php }?> <?php if (@constant('PRODUCT_BUILD')!='') {?> <?php echo htmlspecialchars(@constant('PRODUCT_BUILD'), ENT_QUOTES, 'ISO-8859-1');
}?></b></small></a></li>
            <li><a class="cm-ajax cm-ajax-cache" href="<?php echo htmlspecialchars(fn_url("debugger.request?debugger_hash=".((string)$_smarty_tpl->tpl_vars['debugger_hash']->value)), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id="DebugToolbarTabRequestContent" data-tab-content-id="#DebugToolbarTabRequest">Request</a></li>
            <li><a class="cm-ajax cm-ajax-cache" href="<?php echo htmlspecialchars(fn_url("debugger.config?debugger_hash=".((string)$_smarty_tpl->tpl_vars['debugger_hash']->value)), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id="DebugToolbarTabConfigContent" data-tab-content-id="#DebugToolbarTabConfig">Config</a></li>
            <li><a class="cm-ajax cm-ajax-cache" href="<?php echo htmlspecialchars(fn_url("debugger.sql?debugger_hash=".((string)$_smarty_tpl->tpl_vars['debugger_hash']->value)), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id="DebugToolbarTabSQLContent" data-tab-content-id="#DebugToolbarTabSQL">SQL<?php if ($_smarty_tpl->tpl_vars['warnings']->value['sql']) {?> <span class="deb-warning">!</span><?php }?><small><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['totals']->value['count_queries'], ENT_QUOTES, 'ISO-8859-1');?>
 queries <?php echo htmlspecialchars(number_format($_smarty_tpl->tpl_vars['totals']->value['time_queries'],"4"), ENT_QUOTES, 'ISO-8859-1');?>
 s</small></a></li>
            <li><a class="cm-ajax cm-ajax-cache" href="<?php echo htmlspecialchars(fn_url("debugger.cache_queries?debugger_hash=".((string)$_smarty_tpl->tpl_vars['debugger_hash']->value)), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id="DebugToolbarTabCacheQueriesContent" data-tab-content-id="#DebugToolbarTabCacheQueries">Cache queries<small><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['totals']->value['count_cache_queries'], ENT_QUOTES, 'ISO-8859-1');?>
 queries <?php echo htmlspecialchars(number_format($_smarty_tpl->tpl_vars['totals']->value['time_cache_queries'],"4"), ENT_QUOTES, 'ISO-8859-1');?>
 s</small></a></li>
            <li><a class="cm-ajax cm-ajax-cache" href="<?php echo htmlspecialchars(fn_url("debugger.logging?debugger_hash=".((string)$_smarty_tpl->tpl_vars['debugger_hash']->value)), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id="DebugToolbarTabLoggingContent" data-tab-content-id="#DebugToolbarTabLogging">Logging</a></li>
            <li><a class="cm-ajax cm-ajax-cache" href="<?php echo htmlspecialchars(fn_url("debugger.templates?debugger_hash=".((string)$_smarty_tpl->tpl_vars['debugger_hash']->value)), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id="DebugToolbarTabTemplatesContent" data-tab-content-id="#DebugToolbarTabTemplates" >Templates<small><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['totals']->value['count_tpls'], ENT_QUOTES, 'ISO-8859-1');?>
 included templates</small></a></li>
            <?php if (@constant('AREA')=='C') {?>
                <li><a class="cm-ajax cm-ajax-cache" href="<?php echo htmlspecialchars(fn_url("debugger.blocks?debugger_hash=".((string)$_smarty_tpl->tpl_vars['debugger_hash']->value)), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id="DebugToolbarTabBlocksContent" data-tab-content-id="#DebugToolbarTabBlocks">Blocks<small><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['totals']->value['blocks_rendered'], ENT_QUOTES, 'ISO-8859-1');?>
 (<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['totals']->value['blocks_from_cache'], ENT_QUOTES, 'ISO-8859-1');?>
 from cache) blocks rendered in <?php echo htmlspecialchars(number_format($_smarty_tpl->tpl_vars['totals']->value['blocks_time'],"4"), ENT_QUOTES, 'ISO-8859-1');?>
 s</small></a></li>
            <?php }?>
        </ul>
        ...
        <ul class="deb-resource-usage">
            <li>Page generating time <small><?php echo htmlspecialchars(number_format($_smarty_tpl->tpl_vars['totals']->value['time_page'],"4"), ENT_QUOTES, 'ISO-8859-1');?>
 s</small></li>
            <li>Memory usage <small><?php echo htmlspecialchars(number_format($_smarty_tpl->tpl_vars['totals']->value['memory_page'],"2","."," "), ENT_QUOTES, 'ISO-8859-1');?>
 KB</small></li>
            <?php if (@constant('AREA')=='A') {?>
                <?php if (fn_allowed_for("ULTIMATE")&&!$_smarty_tpl->tpl_vars['runtime']->value['company_id']) {?>
                    <li>Debugger ID is <small><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['debugger_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
</small></li>
                <?php } elseif (fn_allowed_for("MULTIVENDOR")) {?>
                    <li>Debug on <a href="<?php echo htmlspecialchars(fn_url("?".((string)$_smarty_tpl->tpl_vars['config']->value['debugger_token'])."=".((string)$_smarty_tpl->tpl_vars['debugger_id']->value),'C'), ENT_QUOTES, 'ISO-8859-1');?>
" target="_blank" >storefront</a></li>
                <?php } else { ?>
                    <li>Debug on <a href="<?php echo htmlspecialchars(fn_url("?".((string)$_smarty_tpl->tpl_vars['config']->value['debugger_token'])."=".((string)$_smarty_tpl->tpl_vars['debugger_id']->value)."&company_id=".((string)$_smarty_tpl->tpl_vars['runtime']->value['company_id']),'C'), ENT_QUOTES, 'ISO-8859-1');?>
" target="_blank" >storefront</a></li>
                <?php }?>
            <?php }?>
        </ul>
